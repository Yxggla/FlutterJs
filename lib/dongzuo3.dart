...
class dongzuo3 extends StatefulWidget {
  const dongzuo3({Key? key}) : super(key: key);

  @override
  dongzuo3State createState() => dongzuo3State();
}

class dongzuo3State extends State<dongzuo3> {
  ...
  Future<void> _loadFavoriteState() async {
    ...
    setState(() {
      isFavorite = _prefs.getBool('dongzuo3_favorite') ?? false;
    });
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed: () async {
                      ...
                      await _prefs.setBool('dongzuo3_favorite', isFavorite);
                      ButtonProvider buttonProvider = Provider.of<ButtonProvider>(context, listen: false);
                      if (isFavorite) {
                        buttonProvider.addToFavorite('杠铃卧推（宽握距）');
                      } else {
                        buttonProvider.removeFromFavorite('杠铃卧推（宽握距）');
                      }
                    },
              ...
              SizedBox(height: 14.0),
              Text(
                '1.杠铃位于眼睛正上方，使用比肩更宽的握距握住杠铃；双脚踩实地面，臀部收紧，绷紧腹部，保持核心稳定，肩胛骨后缩下沉，上背平贴凳子',
                style: TextStyle(
                  color: Colors.grey,
                  fontSize: 16,
                ),
